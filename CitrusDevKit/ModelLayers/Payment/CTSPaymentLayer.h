...
- (void)requestChargeCitrusCashWithContact:(CTSContactUpdate*)contactInfo
                              ...
                              customParams:(NSDictionary *)custParams
                      returnViewController:(UIViewController *)controller
                     withCompletionHandler:(ASCitruspayCallback)callback DEPRECATED_MSG_ATTRIBUTE("Use requestChargeCitrusWalletWithContact:address:bill:returnViewController:withCompletionHandler: ");
