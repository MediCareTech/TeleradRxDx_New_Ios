 ...
 */
-(void)requestDeleteCard:(NSString *)lastFourDigits scheme:(NSString *)scheme withCompletionHandler:(ASDeleteCardCallback)callback DEPRECATED_MSG_ATTRIBUTE("Use 'requestDeleteCardWithToken:withCompletionHandler:'") ;
