...
#import "SmartRxServiceDetailCell.h"

@implementation SmartRxServiceDetailCell
...
- (void)setCellData:(NSDictionary *)arrayRequestData row:(NSInteger)rowIndex
{
    ...
    self.imagePath.text = [arrImg objectAtIndex:arrImg.count-1];//[NSString stringWithFormat:@"%@", [arrImg objectAtIndex:1]];
