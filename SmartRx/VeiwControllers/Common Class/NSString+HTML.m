...
//    self = [self stringByReplacingOccurrencesOfString: @"<br/>" withString: @"\n"];
//- (id)init
//{
//    self = [self stringByReplacingOccurrencesOfString: @"<br/>" withString: @"\n"];
//    return self;
...
- (NSString *)stringByStrippingTags {
	...
	// Strings
	NSMutableString *result = [[NSMutableString alloc] initWithString:[self stringByReplacingOccurrencesOfString: @"<br/>" withString: @"\n"]];
    ...
    finalString = result;
    //[result stringByRemovingNewLinesAndWhitespace];
