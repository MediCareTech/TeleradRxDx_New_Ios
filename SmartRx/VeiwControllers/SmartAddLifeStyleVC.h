...
@interface SmartAddLifeStyleVC : UIViewController<UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate>
{
    UIView *pickerAction;
...
@property(nonatomic,weak) IBOutlet UILabel *lifestyleLbl;
@end
