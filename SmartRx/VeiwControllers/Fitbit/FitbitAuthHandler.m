...
-(void)getAccessToken:(BOOL)success{
     ...
     if (success) {
        ...
        [manager POST:@"https://api.fitbit.com/oauth2/token" parameters:param success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
...
-(void)revokeAccessToken:(NSString *)token{
    ...
    [manager POST:@"https://api.fitbit.com/oauth2/revoke" parameters:params success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
